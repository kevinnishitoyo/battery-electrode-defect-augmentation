...
> **Key finding:** Ordinary oversampling achieved the highest mean macro F1 ({fmt(best_macro['macro_f1_mean'])} ± {fmt(best_macro['macro_f1_std'])}) and outperformed every learned synthetic-augmentation arm.
